...
;; Fixed 'color quotedn' regexp where n is 1-9
;; Francesco Lazzarino flaz_NOSPAM@ufl.edu
...
;; quotedn where n is 1-9 now works
  (eval-when-compile
    (list
     '("alias[ \t]+\\([^ \t]+\\)"
...
"generic" "hdrs" "hdr_format" "header" "header_cache" "help" "hidden_host" "hide_limited"
...
"message_format" "message_cachedir" "pager" "pager_context" "pager_format"
...
"pop_pass" "post_indent_string" "postpone" "postponed" "posted-to"
"preconnect" "print" "print_command" "print_decode" "print_split" "prompt_after"
...
"strict_threads" "suspend" "text_flowed" "thread_received" "smtp_url"
"smtp_pass"
...
"write_bcc" "x-mailing-list" "x-mailer")) "\\)\\>")
